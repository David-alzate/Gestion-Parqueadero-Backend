...
import co.com.park.gp.business.usecase.impl.sesionesparqueo.sesionparqueo.ConsultarSesionParqueoActiva;
...
public class ConsultarSesionParqueoActivaFacade implements FacadeWhitReturn<SesionParqueoDTO, List<SesionParqueoDTO>> {

    private final DAOFactory daoFactory;

    public ConsultarSesionParqueoActivaFacade() {
    ...
    public List<SesionParqueoDTO> execute(SesionParqueoDTO dto) {
        try {
            var useCase = new ConsultarSesionParqueoActiva(daoFactory);
            ...
            var mensajeUsuario = "Se ha presentado un problema al consultar la información de las sesiones de parqueo Activas";
