...
public final class TipoSedeAssemblerDTO implements AssemblerDTO<TipoSedeDomain, TipoSedeDTO> {
    ...
    public static AssemblerDTO<TipoSedeDomain, TipoSedeDTO> getInstance() {
        return instance;
    }

    @Override
    public TipoSedeDomain toDomain(final TipoSedeDTO data) {
    ...
    @Override
    public TipoSedeDTO toDto(final TipoSedeDomain domain) {
